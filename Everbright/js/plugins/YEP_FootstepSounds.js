...
var ckesound = JSON.parse(Yanfly.Parameters["Default Sound"]);
//var ckedsound = ckesound[Math.randomInt(ckesound.length)];

Yanfly.Param.Footsteps = {
  defaultSound:   ckesound[0],
...
Game_CharacterBase.prototype.playFootstepSound = function(volume, pitch, pan) {
  ...
  var se = {
    name:   ckesound[Math.randomInt(ckesound.length)],
